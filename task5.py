...
parser.add_argument("-id", metavar="<user_name>", help="Lists user repos",
                    required=True)
parser.add_argument("-r", metavar="<repo_name>",
                    help="Lists requests of repo. User (-id) required",
                    default=None)
parser.add_argument("-n", metavar="<number>",
                    help="Request number User (-id) and repo (-r) required",
                    default=None)
parser.add_argument("-s", metavar="<user_name>",
                    help="Name of the sender. User (-id) and repo (-r) required",
                    default=None)
